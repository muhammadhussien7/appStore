...
export default function ShopIcon() {
    function OffCanvasExam({ name, ...props }) {
        ...
        return (
            <Fragment>
                <Link onClick={handleShow} to='#'> 
                    ...
                    <span>{cartTotal.cartTotalQuantity}</span> 
                </Link>
                <Offcanvas show={show} onHide={handleClose} {...props}>
                    ...
                    <form className='cart-view'>
                        <Link to='cart' className='cart-btn'>
                            <span>View Cart </span>
                            <span>{`$ ${cartAmount.cartTotalAmount}`}</span>
                        </Link>
                    </form>
                </Offcanvas>
            </Fragment>
    ...
    return (
        <Fragment>
            {['end'].map((placement, indx) => (
                <OffCanvasExam key={indx} placement={placement} name={placement} />
            ))}
        </Fragment>
    )
}
